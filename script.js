...
form.addEventListener("submit", function (event) {
  ...
  if (q2 === "udp_quic") {
    score++;
    feedbackHtml +=
      '<p class="correct">Q2: Correct! HTTP/3 uses QUIC over UDP.</p>';
  } else {
    feedbackHtml +=
      '<p class="incorrect">Q2: Incorrect. Correct answer: UDP using QUIC.</p>';
  }
  ...
  if (q4 === "443") {
    score++;
    feedbackHtml +=
      '<p class="correct">Q4: Correct! HTTPS typically uses port 443 by default.</p>';
  } else {
    feedbackHtml +=
      '<p class="incorrect">Q4: Incorrect. Correct answer: Port 443.</p>';
  }
